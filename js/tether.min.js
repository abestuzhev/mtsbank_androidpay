!(function(t, e) {
	'function' == typeof define && define.amd
		? define(e)
		: 'object' == typeof exports ? (module.exports = e(require, exports, module)) : (t.Tether = e());
})(this, function(t, e, o) {
	'use strict';
	function i(t, e) {
	...
	function w() {
		...
		return o.forEach(function(e) {
			var o = e.top,
				i = e.left;
			'string' == typeof o &&
				(o = parseFloat(o, 10)), 'string' == typeof i && (i = parseFloat(i, 10)), (t.top += o), (t.left += i);
		}), t;
	}
	function C(t, e) {
		return 'string' == typeof t.left &&
			...
			(t.left =
				...
				100 *
				e.width), 'string' == typeof t.top && t.top.indexOf('%') !== -1 && (t.top = parseFloat(t.top, 10) / 100 * e.height), t;
	}
	function O(t, e) {
		return 'scrollParent' === e
			...
			: 'window' === e &&
				...
				]), e === document && (e = e.documentElement), 'undefined' != typeof e.nodeType &&
			!(function() {
				var t = e,
					o = a(e),
					i = o,
			...
			return E(t, [
				{
					...
					value: function(t, e, o) {
						...
						'undefined' == typeof this.bindings && (this.bindings = {}), 'undefined' == typeof this.bindings[t] &&
							(this.bindings[t] = []), this.bindings[t].push({ handler: e, ctx: o, once: i });
					}
				},
				{
					key: 'once',
	...
	var F = { center: 'center', left: 'right', right: 'left' },
		...
		I = (function(t) {
			function e(t) {
				var o = this;
				i(this, e), j(Object.getPrototypeOf(e.prototype), 'constructor', this).call(this), (this.position = this.position.bind(
					this
				)), D.push(this), (this.history = []), this.setOptions(t, !1), x.modules.forEach(function(t) {
			...
			return v(e, t), E(e, [
				...
				},
				{
					...
					value: function(t) {
						...
						(this.targetAttachment = q(this.options.targetAttachment)), (this.attachment = q(
							this.options.attachment
						)), (this.offset = R(this.options.offset)), (this.targetOffset = R(this.options.targetOffset)), 'undefined' !=
							typeof this.scrollParents && this.disable(), 'scroll-handle' === this.targetModifier
							? (this.scrollParents = [this.target])
							: (this.scrollParents = r(this.target)), this.options.enabled !== !1 && this.enable(o);
					}
				},
				{
					key: 'getTargetBounds',
					value: function() {
						...
						if ('visible' === this.targetModifier) {
							...
							return (e.height = Math.min(e.height, t.height - (pageYOffset - t.top))), (e.height = Math.min(
								e.height,
								t.height - (t.top + t.height - (pageYOffset + innerHeight))
							)), (e.height = Math.min(innerHeight, e.height)), (e.height -= 2), (e.width = Math.min(
								e.width,
								t.width - (pageXOffset - t.left)
							)), (e.width = Math.min(e.width, t.width - (t.left + t.width - (pageXOffset + innerWidth)))), (e.width = Math.min(
								innerWidth,
								e.width
							)), (e.width -= 2), e.top < pageYOffset && (e.top = pageYOffset), e.left < pageXOffset && (e.left = pageXOffset), e;
						}
						if ('scroll-handle' === this.targetModifier) {
							...
							var s = t.height - parseFloat(i.borderTopWidth) - parseFloat(i.borderBottomWidth) - r,
								...
								f = 0;
							s < 408 && this.target === document.body && (f = -11e-5 * Math.pow(s, 2) - 0.00727 * s + 22.58), this.target !==
								document.body && (e.height = Math.max(e.height, 24));
							var l = this.target.scrollTop / (o.scrollHeight - s);
							return (e.top = l * (s - e.height - f) + t.top + parseFloat(i.borderTopWidth)), this.target === document.body &&
				...
				},
				{
					key: 'cache',
					value: function(t, e) {
						return 'undefined' == typeof this._cache && (this._cache = {}), 'undefined' == typeof this._cache[t] &&
				...
				},
				{
					...
					value: function() {
						...
						this.options.addTargetClasses !== !1 && p(this.target, this.getClass('enabled')), p(
							this.element,
				...
				},
				{
					...
					value: function(t, e) {
						...
						'undefined' != typeof this._addAttachClasses &&
							...
							this._addAttachClasses.splice(0, this._addAttachClasses.length), 'undefined' == typeof this._addAttachClasses &&
							(this._addAttachClasses = []);
						var n = this._addAttachClasses;
						t.top && n.push(this.getClass('element-attached') + '-' + t.top), t.left &&
					...
					value: function() {
						...
						if (this.enabled) {
							...
							return T.innerHeight > A.documentElement.clientHeight &&
								...
								A.documentElement.clientWidth && ((S = this.cache('scrollbar-size', l)), (E.viewport.right -= S.width)), ([
								'',
								'static'
							].indexOf(A.body.style.position) !== -1 &&
								['', 'static'].indexOf(A.body.parentElement.style.position) !== -1) ||
								((E.page.bottom = A.body.scrollHeight - v - r), (E.page.right = A.body.scrollWidth - m - n)), 'undefined' !=
							...
							var l = { top: '', left: '', right: '', bottom: '' },
								d = function(t, o) {
									...
									if (n !== !1) {
										...
										t.top ? (l.top = o.top + 'px') : (l.bottom = o.bottom + 'px'), t.left
											? (l.left = o.left + 'px')
											: (l.right = o.right + 'px');
								},
								p = !1;
		...
		position: function(t) {
			...
			return this.options.constraints.forEach(function(t) {
				...
				('target' !== d && 'both' !== d) ||
					...
					), 'together' === d && ('top' === v.top && ('bottom' === y.top && o < b[1] ? ((o += p), (v.top = 'bottom'), (o += s), (y.top = 'top')) : 'top' === y.top && o + s > b[3] && o - (s - p) >= b[1] && ((o -= s - p), (v.top = 'bottom'), (y.top = 'bottom'))), 'bottom' === v.top && ('top' === y.top && o + s > b[3] ? ((o -= p), (v.top = 'top'), (o -= s), (y.top = 'bottom')) : 'bottom' === y.top && o < b[1] && o + (2 * s - p) <= b[3] && ((o += s - p), (v.top = 'top'), (y.top = 'top'))), 'middle' === v.top && (o + s > b[3] && 'top' === y.top ? ((o -= s), (y.top = 'bottom')) : o < b[1] && 'bottom' === y.top && ((o += s), (y.top = 'top')))), ('target' !== h && 'both' !== h) || (i < b[0] && 'left' === v.left && ((i += u), (v.left = 'right')), i + f > b[2] && 'right' === v.left && ((i -= u), (v.left = 'left'))), 'together' === h && (i < b[0] && 'left' === v.left ? ('right' === y.left ? ((i += u), (v.left = 'right'), (i += f), (y.left = 'left')) : 'left' === y.left && ((i += u), (v.left = 'right'), (i -= f), (y.left = 'right'))) : i + f > b[2] && 'right' === v.left ? ('left' === y.left ? ((i -= u), (v.left = 'left'), (i -= f), (y.left = 'right')) : 'right' === y.left && ((i -= u), (v.left = 'left'), (i += f), (y.left = 'left'))) : 'center' === v.left && (i + f > b[2] && 'left' === y.left ? ((i -= f), (y.left = 'right')) : i < b[0] && 'right' === y.left && ((i += f), (y.left = 'left')))), ('element' !== d && 'both' !== d) || (o < b[1] && 'bottom' === y.top && ((o += s), (y.top = 'top')), o + s > b[3] && 'top' === y.top && ((o -= s), (y.top = 'bottom'))), ('element' !== h && 'both' !== h) || (i < b[0] && ('right' === y.left ? ((i += f), (y.left = 'left')) : 'center' === y.left && ((i += f / 2), (y.left = 'left'))), i + f > b[2] && ('left' === y.left ? ((i -= f), (y.left = 'right')) : 'center' === y.left && ((i -= f / 2), (y.left = 'right')))), 'string' ==
				typeof l
				...
				o < b[1] &&
					(l.indexOf('top') >= 0
						...
						: C.push(
								'top'
							)), o + s > b[3] && (l.indexOf('bottom') >= 0 ? ((o = b[3] - s), w.push('bottom')) : C.push('bottom')), i < b[0] && (l.indexOf('left') >= 0 ? ((i = b[0]), w.push('left')) : C.push('left')), i + f > b[2] && (l.indexOf('right') >= 0 ? ((i = b[2] - f), w.push('right')) : C.push('right')), w.length &&
					!(function() {
						var t = void 0;
						(t = 'undefined' != typeof e.options.pinnedClass ? e.options.pinnedClass : e.getClass('pinned')), g.push(
							t
					...
					!(function() {
						...
						(t =
							'undefined' != typeof e.options.outOfBoundsClass
								...
								: e.getClass('out-of-bounds')), g.push(t), C.forEach(function(e) {
							g.push(t + '-' + e);
						});
					})(), (w.indexOf('left') >= 0 || w.indexOf('right') >= 0) &&
					(y.left = v.left = !1), (w.indexOf('top') >= 0 || w.indexOf('bottom') >= 0) && (y.top = v.top = !1), (v.top === n.top && v.left === n.left && y.top === e.attachment.top && y.left === e.attachment.left) || (e.updateAttachClasses(y, v), e.trigger('update', { attachment: y, targetAttachment: v }));
			}), k(function() {
